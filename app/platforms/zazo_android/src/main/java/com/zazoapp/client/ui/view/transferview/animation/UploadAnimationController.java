...
import com.zazoapp.client.ui.view.transferview.animation.listeners.UploadAnimationListener;

/**
 * Created by sergii on 14.11.15.
 */
public class UploadAnimationController extends TransferAnimationController implements UploadAnimationListener {

    private static final String TAG = UploadAnimationController.class.getSimpleName();
    ...
    public UploadAnimationController(){
        initAnimation();
    }
