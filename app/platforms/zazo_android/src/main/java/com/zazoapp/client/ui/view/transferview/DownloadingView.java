...
import com.zazoapp.client.ui.view.transferview.animation.DownloadAnimationController;
import com.zazoapp.client.ui.view.transferview.background.DownloadingBackground;
import com.zazoapp.client.ui.view.transferview.foregroud.Foreground;

/**
 * Created by sergii on 14.11.15.
 */
public class DownloadingView extends ITransferView {

    private DownloadAnimationController animationController;
    private DownloadingBackground background;
    ...
    private void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        animationController = new DownloadAnimationController(getContext());
    ...
    private DownloadingBackground createBackground(TypedArray typedArray ) {
        ...
        DownloadingBackground background = new DownloadingBackground( getContext() );
    ...
    @Override
    public DownloadAnimationController getAnimationController() {
